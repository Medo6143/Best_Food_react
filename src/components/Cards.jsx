  ...
  return (
    ...
    <div className='rounded-xl relative'>
      ...
      <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
        ...
        <button className=' font-serif font-bold hover:bg-orange-500  rounded-lg border-white bg-white text-black mx-2 absolute bottom-4 border px-5 py-1'>Order Now</button>
      </div>
      <img
